...
DefaultCenterLat = 48.71059270731569;
DefaultCenterLon = 15.063997458490348;
...
SiteLat     = 48.71059270731569;       // position of the marker
SiteLon     = 15.063997458490348;
SiteName    = "ADS-B Receiver"; // tooltip of the marker
...
UserMap     = "https://github.com/TheNogl/flighttrackdata/raw/master/rangeview2.kml";  // your KML URL (publicly available domain)
UserMap2    = "https://github.com/TheNogl/flighttrackdata/raw/master/mlat_rangeview.kml";
...
SiteCircle = [
        { distance:  25, strokeweight: 3, color: "black" },
        { distance:  50, strokeweight: 3, color: "OrangeRed" },
        { distance:  75, strokeweight: 3, color: "red" },
        { distance: 100, strokeweight: 3, color: "purple" },
        { distance: 125, strokeweight: 3, color: "green" },
        { distance: 150, strokeweight: 3, color: "DeepSkyBlue" },
        { distance: 175, strokeweight: 3, color: "navy" }
];
