...
function getAltitudeZoneColors(NumberOfZones) {
	...
	for (var altitude_zone = 0; altitude_zone < NumberOfZones; ++altitude_zone){
		...
		// Create HTML code
		html=html+'<li class="color" style="list-style-position: inside; padding-left: 5px; background-color:'+zone_color+';">'+low_altitude_zone_border+'-'+high_altitude_zone_border+unittype+'</li>';
	}
